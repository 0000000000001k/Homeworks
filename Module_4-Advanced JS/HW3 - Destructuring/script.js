...
// за допомогою деструктуризації, можливо витягувати певні значення з об"єкта в нову змінну.
...
const concatArray = [...clients1, ...clients2]

const result = concatArray.reduce((previousValue, currentValue) => {
    if (!previousValue.find(double => double === currentValue)) {
...
//
const fullArray = []
fullArray.push([...books, {...bookToAdd}])
...
const fullInfo = {...employee, age: 51, salary: 52734}
